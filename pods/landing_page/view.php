...
/**********************************************/
	...
	//$POD->header( $doc->get('headline')  ); //removed as a entire custom landing page will be developed
	$doc->output( $output_template);
	//$POD->footer(); //removed as a entire custom landing page will be developed
?>