...
/**********************************************/
	...
	if ($mode == "friends") {
		...
		$title = "My Friends";
		$header = "You have " . $people->totalCount() . " " . $POD->pluralize($people->totalCount(),'patient','patients');
	}
	...
	//@todo recommended patients might just need to come out of this file
	if ($mode=="recommended") { 
	...
	?>
		<div id="friends_actions">
			...
			<ul>
				<li <?php if ($mode=="friends") { ?>class="active"<?php } ?>><a href="<?php $POD->siteRoot(); ?>/friends">Patients</a></li>
