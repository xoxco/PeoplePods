<?php 
	...
	<div class="list_panel">
		...
		<?php if (@$_GET['userId']) { 
			...
			?><h1>Content created by <?php echo $person->nick; ?></h1><?
		} ?>
		...
		<ul id="content_type">
			<li>Content Type:</li>
			<li <?php if (!isset($_GET['type'])) { ?>class="active"<?php } ?>><A href="search.php?<?php echo $tparameters; ?>">All</a></li>
			<?php foreach ($types as $type) { ?>
				<li <?php if (isset($_GET['type']) && $_GET['type']==$type) {?>class="active"<?php } ?>><a href="?type=<?php echo $type; ?><?php echo $tparameters; ?>"><?php echo $type; ?></a></li>
			<?php } ?>
		</ul>
