...
function dashboard() {
	return header("Location: /PeoplePods/pods/dashboard/index.php");
}# core_dashboard //needs to go to /PeoplePods/pods/dashboard/index.php	[QSA,L] # core_dashboard

function unauthorized() {
	return header("Location: /PeoplePods/pods/unauthorizes_landing_page/index.php");
...
function conversation() {
	return header("Location: /PeoplePods/pods/core_private_messaging/thread.php?username=$username");
...
function openId() {
	return header("Location: /PeoplePods/pods/openid_connect/index.php?mode=$mode");
}//openId" )-> //needs to go to /PeoplePods/pods/openid_connect/index.php?mode=$mode	[QSA,L] # openid_connect

function openId() {
	return header("Location: /PeoplePods/pods/openid_connect/index.php");
...
function friends() {
	return header("Location: /PeoplePods/pods/core_friends/index.php?mode=$mode");
...
function admin() {
	return header("Location: /PeoplePods/admin/index.php");
}//admin" )->

function api1() {
	return header("Location: /PeoplePods/pods/core_api_simple/index_version1.php");
}//api" )-> //needs to go to /PeoplePods/pods/core_api_simple/index_version1.php	[QSA,L] # core_api_simple

function api2() {
	return header("Location: /PeoplePods/pods/core_api_simple/index_version2.php?method=$method");
...
function install() {//todo check if database is present before routing to install
	return header("Location: /PeoplePods/install/index.php");
